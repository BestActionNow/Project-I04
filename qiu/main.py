...
if __name__ == "__main__":
    print('bengin')
    data = pd.read_csv('./data/bytecamp.txt', sep=',', header=0)
    ...
    # origin_feature_names = data.columns.values.tolist()
    ...
    # target_index = [origin_feature_names.index(fn) for fn in target]
    ...
    model = MT_xDeepFM(linear_feature_columns, dnn_feature_columns)
